...
namespace Infrastructure.Repositories
{
    public class MenuService : IMenuService
    {
        ...
        public MenuService(AppDbContext _db, ICurrentUser currentUser, AuthDbContext authDb, RoleManager<AppRole> roleManager, UserManager<AppUser> userManager)
        {
            this._db = _db;
            ...
            IEnumerable<dynamic> roleMenus)
        {
            ...
            {
                var titlePart = menu.Title?.ToLowerInvariant() ?? string.Empty;
                var currentMenuCode = string.IsNullOrEmpty(parentMenuCode) ? titlePart : $"{parentMenuCode}.{titlePart}";
